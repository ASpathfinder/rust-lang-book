...
下面列出英语以外其他语言的资源。大多数仍在翻译中；如想提供帮助或告知我们新的译本，请查看 [Translations 标签][label]！

[label]: https://github.com/rust-lang/book/issues?q=is%3Aopen+is%3Aissue+label%3ATranslations

- [Português](https://github.com/rust-br/rust-book-pt-br)（巴西）
- [Português](https://github.com/nunojesus/rust-book-pt-pt)（葡萄牙）
...
- [Español](https://github.com/thecodix/book)、[备选译本](https://github.com/ManRR/rust-book-es)、[Español por RustLangES](https://github.com/RustLangES/rust-book-es)
